...
<html>
    ...
    <body>
        ...
        <section id="detalle_carga_principal">
            ...
            <?php
            if ( $carga['lvl_privilegios'] != 1 && $carga['fecha_final'] > date("Y-m-d") ) {
                    ...
                    echo '<li>';
                        echo '<a class="a_des" id="opcion1_editar_borrar_carga" href="#">&#9998;';
                            echo '<form class="formulario form2" id="form_editar_carga" method="POST" action="">';
                                echo '<input type="hidden" name="cod_carga" value="'.$carga['codigo'].'">';
            ...
            <form class="formulario" id="form_detalle_carga" method="POST" action="">
                ...
                echo '<div class="label_form">';
                    echo '<h4>&#127963;  '.entidad.':</h4>';
                    echo '<input class="input" type="text" value="'.$carga['entidad'].'" disabled>';
                echo '</div>';
                echo '<div class="label_form">';
                    echo '<h4>&#128104;&#65038;  '.responsable.':</h4>';
                    echo '<input class="input" type="text" value="'.$carga['responsable'].'" disabled>';
                echo '</div>';
                
                echo '<br><br>';
                echo '<div class="label_form" id="label_fecha_ini_detalle">';
                    echo '<h4>&#128467;   '.fecha_inicio.':</h4>';
                    if ( $carga['fecha_inicio'] != null ) {
                        echo '<input class="input" type="date" value='.$carga['fecha_inicio'].' disabled>';
                    } else {
                ...
                echo '<div class="label_form" id="label_fecha_fin_detalle">';
                    ...
                    if ( $carga['fecha_final'] != null ) {
                        echo '<input class="input" type="date" value='.$carga['fecha_final'].' disabled>';
                    } else {
                        echo '<input class="input" type="text" value="'.sin_establecer_m.'" disabled>';
                    }
                echo '</div>';
                echo '<div class="label_form" id="label_fecha_cadu_detalle">';
                    ...
                    if ( $carga['fecha_caducidad'] != null ) {
                        echo '<input class="input" type="date" value='.$carga['fecha_caducidad'].' disabled>';
                    } else {
                        echo '<input class="input" type="text" value="'.sin_establecer_m.'" disabled>';
                    }
                echo '</div>';
                ...
                echo '<div class="label_form">';
                    ...
                    if ( $carga['num_contenedores'] != null ) {
                        echo '<input class="input" type="text" value="'.$carga['num_contenedores'].'" disabled>';
                    } else {
                        echo '<input class="input" type="text" value="'.sin_establecer_m.'" disabled>';
                    }
                echo '</div>';
                echo '<div class="label_form">';
                    ...
                    if ( $carga['kgs_totales'] != null ) {
                        echo '<input class="input" type="text" value="'.$carga['kgs_totales'].'" disabled>';
                    } else {
                        echo '<input class="input" type="text" value="'.sin_establecer_m.'" disabled>';
                    }
                echo '</div>';
                echo '<div class="label_form">';
                    ...
                    if ( $carga['producto'] != null ) {
                        echo '<input class="input" type="text" value="'.fx_recoger_nombre_producto( $cn, $carga['producto'] ).'" disabled>';
                    } else {
                        echo '<input class="input" type="text" value="'.sin_establecer_m.'" disabled>'; 
                    }
                echo '</div>';
                ...
                echo '<div class="label_form">';
                    echo '<h4>&#11016;   '.origen.':</h4>';
                    if ( $carga['nombre_origen'] != null ) {
                        echo '<input class="input" type="text" value="'.$carga['nombre_origen'].'" disabled>';
                    } else {
                        echo '<input class="input" type="text" value="'.sin_establecer_m.'" disabled>'; 
                    }
                echo '</div>';
                echo '<div class="label_form">';
                    echo '<h4>&#11019;   '.destino.':</h4>';
                    if ( $carga['nombre_destino'] != null ) {
                        echo '<input class="input" type="text" value="'.$carga['nombre_destino'].'" disabled>';
                    } else {
                        echo '<input class="input" type="text" value="'.sin_establecer_m.'" disabled>';
                    }
                echo '</div>';
            ...
            <?php
            if ( $carga['latitud_origen'] != null && $carga['longitud_origen'] != null && $carga['latitud_destino'] != null && $carga['longitud_destino'] != null ) {
            ?>
            <div id ="map3"> </div>
            ...
            <div class="seccion_oculta" id="lista_dataloggers_detalle_carga">
                ...
                <?php
                $enlaces = fx_recoger_dataloggers_carga( $cn, $carga['codigo'] );
            ...
            <div class="seccion_oculta" id="lista_subrutas_detalle_carga">
                ...
                <?php
                $subrutas = fx_recoger_subrutas_carga( $cn, $carga['codigo'], $_SESSION['ss_usuario'] );
